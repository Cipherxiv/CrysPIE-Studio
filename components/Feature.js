...
export const Feature = () => {
    return (
      <div id="Apps" className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-29">
        <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
          <div className="lg:w-1/2">
            <h2 className="max-w-md mb-16 font-sans text-3xl font-bold tracking-tight text-blue-950 sm:text-4xl sm:leading-none xl:max-w-lg">
              We at also develop various Applications for your needs
            </h2>
          </div>
          <div className="lg:w-1/2">
        ...
        <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-blue-950">
              <svg
                className="w-7 h-7 text-deep-orange-300"
                strokeLinecap="round"
                strokeWidth="2"
                viewBox="0 0 24 24"
              >
            ...
            <h6 className="mb-2 text-blue-950 font-semibold leading-5">Pixel Browser</h6>
            <p className="mb-3 text-sm text-blue-950">
              We choose to go to the moon, not because it's easy, but because it's
              hard.
            </p>
            <ul className="text-blue-950 mb-4 -ml-1 space-y-2">
              <li className="flex items-start">
                <span className="mr-1">
                  <svg
                    className="w-5 h-5 mt-px text-deep-orange-300"
                    stroke="currentColor"
                    viewBox="0 0 52 52"
                  >
                    <polygon
            ...
            <a
              href="/"
              aria-label=""
              className="inline-flex items-center font-semibold transition-colors duration-200 text-deep-orange-300 hover:text-blue-950"
            >
              Learn more
            </a>
          </div>
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Alien App</h6>
            <p className="mb-3 text-sm text-blue-950">
              There can be no thought of finishing for "aiming for the stars".
            </p>
            <ul className="mb-4 -ml-1 space-y-2 text-blue-950">
              <li className="flex items-start">
                <span className="mr-1">
                  <svg
                    className="w-5 h-5 mt-px text-deep-orange-300"
